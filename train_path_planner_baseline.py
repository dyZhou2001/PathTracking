"""Train a baseline CNN path planner.
...
Example:
  python train_path_planner_baseline.py --labels dataset/run_xxx/labels.jsonl --epochs 10
"""
...
from nn_path_planner.models_baseline import BaselinePlannerNet
...
def main() -> None:
    ...
    p.add_argument("--save_dir", default="checkpoints_baseline", help="Where to save checkpoints")
    ...
    model = BaselinePlannerNet(num_points=15).to(device)
